...
def create_continuation_prompt(story_history, choices, choice):
    PROMPT = f"""ROLE: You are a QT-robot storyteller for children.

        TASK:
        1) Do NOT ask the user for anything. Immediately create a story using the given words and objects.
        You have already covered the following story: {story_history}
        The following Choices were given: {choices}
        You have to create a contiunation from this point on with the following choice: {choice}
...
def create_end_prompt(story_history, choices, choice):
    PROMPT = f"""ROLE: You are a QT-robot storyteller for children.
        ...
        The following Choices were given: {choices}
        You have to create a contiunation from this point on with the following choice: {choice}
        The story has run its course and you have to create a proper ending now.
